...
func _ensure_registry_populated() -> void:
	...
	MicrogameRegistry.register_microgame("end_the_pandemic", "res://microgames/mg02_end_the_pandemic/MicrogameEndThePandemic.tscn", 1.0, true)
	MicrogameRegistry.register_microgame("wall_builder", "res://microgames/mg03_wall_builder/WallBuilder.tscn", 1.0, true)
	MicrogameRegistry.register_microgame("disinfectant_brainstorm", "res://microgames/mg04_disinfectant_brainstorm/Microgame04_DisinfBrainstorm.tscn", 1.0, true)
	MicrogameRegistry.register_microgame("peace_deal_speedrun", "res://microgames/mg05_peace_deal_speedrun/Microgame05_PeaceDealSpeedrun.tscn", 1.0, true)
	SequenceManager.initialize(MicrogameRegistry)
